...
export const translations = {
  ...
  contact: {
    ...
    kindLabel: { en: "Kind of Request", he: "סוג פנייה" },
    kindGeneral: { en: "General Inquiry", he: "פנייה כללית" },
    kindQuote: { en: "Request a Quote", he: "בקשת הצעת מחיר" },
    kindSupport: { en: "Technical Support", he: "תמיכה טכנית" },
    kindPartnership: { en: "Business Partnership", he: "שותפות עסקית" },
